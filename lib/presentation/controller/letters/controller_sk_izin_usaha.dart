...
class ControllerSkIzinUsaha extends GetxController {
  ...
  Future<void> insertIzinUsaha() async {
    ...
    try {
      ...
      var request = http.MultipartRequest(
          'POST', Uri.parse("${apiService}insertizinusaha"));
      ...
      request.fields['usaha'] = controllerUsaha.text;
